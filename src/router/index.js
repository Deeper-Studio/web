    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/submit',
          name: 'Submit',
          component: () => import('../components/upload/Submit')
        },
        {
          path: '/submit/success',
          name: 'Success',
          component: () => import('../components/upload/Success')
        },
        {
          path: '/jotter/article',
          name: 'Article',
        ...
        },
        {
          ...
          meta: {
            requireAuth: true // 用户登陆状态检测，true开启检测
          }
        },
        {
          path: '/library',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/admin/review',
          name: 'Review',
          component: () => import('../components/admin/Review')
        }
      ]
    },
    {
